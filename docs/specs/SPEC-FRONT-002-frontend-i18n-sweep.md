...
- [x] The i18n job actually gates: `main`'s branch protection (added
      2026-08-10) lists "Frontend — i18n checks" in
      `required_status_checks.contexts`, so the job blocks a merge rather than
      merely reporting.
