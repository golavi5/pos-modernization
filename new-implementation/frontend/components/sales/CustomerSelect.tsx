    ...
    <div className="bg-white rounded-lg border p-4">
      ...
      {selectedCustomer ? (
        <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
          ...
          <div className="flex-1 min-w-0">
            ...
            {selectedCustomer.email && (
              <p className="text-sm text-tertiary">{selectedCustomer.email}</p>
            )}
          </div>
        ...
        <div className="relative">
          ...
          {showSearch && (
            <>
              <div className="absolute z-10 w-full mt-2 bg-white border rounded-lg shadow-lg max-h-80 overflow-hidden">
                {/* Search input */}
